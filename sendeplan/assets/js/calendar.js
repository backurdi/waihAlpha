...
function showEventDetail(id, layout, day, month, year) {
	jQuery('.tiva-events-calendar.' + layout + ' .back-calendar').show(350);
	jQuery('.tiva-events-calendar.' + layout + ' .tiva-calendar').hide(350);
	jQuery('.tiva-events-calendar.' + layout + ' .tiva-event-list').hide(350);
	jQuery('.tiva-events-calendar.' + layout + ' .tiva-event-detail').fadeIn(350);
...
jQuery(document).ready(function(){
	...
	// Show - Hide view
	jQuery('.tiva-events-calendar .back-calendar').hide(350);
	jQuery('.tiva-event-list').hide(350);
	jQuery('.tiva-event-detail').hide(350);
	...
	jQuery('.tiva-events-calendar').each(function(index) {
		...
		if (switch_button == 'hide') {
			jQuery(this).find('.calendar-view').hide(350);
			jQuery(this).find('.list-view').hide(350);
	...
	jQuery('.tiva-events-calendar .calendar-view').click(function(){
		jQuery(this).parents('.tiva-events-calendar').find('.back-calendar').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-event-list').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-event-detail').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-calendar').fadeIn(350);
	...
	jQuery('.tiva-events-calendar .list-view').click(function(){
		jQuery(this).parents('.tiva-events-calendar').find('.back-calendar').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-calendar').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-event-detail').hide(350);
		jQuery(this).parents('.tiva-events-calendar').find('.tiva-event-list').fadeIn(350);
